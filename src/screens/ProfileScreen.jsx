...
// global config, so omitting these here would drop the YouTube scope/offline access.
  ...
  const handleSignOut = () => {
    Alert.alert(t('profile.signOutTitle'), t('profile.signOutMsg'), [
      { text: t('common.cancel'), style: 'cancel' },
      {
        ...
        style: 'destructive',
        onPress: async () => {
          try { await GoogleSignin.revokeAccess(); await GoogleSignin.signOut(); } catch (e) { console.log(e); }
          signOut();
        },
      },
    ]);
