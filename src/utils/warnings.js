export function getWarnings(t) {
  return {
    ...
    beforeLikeComment: {
      ...
      message: t('warnings.beforeLikeComment.message'),
...
export const WARNINGS = {
  ...
  beforeLikeComment: { title: '⚠️ Like + Comment Task', message: 'To earn the maximum reward:\n\n1. 👍 Like the video (required — verified by YouTube)\n2. 💬 Leave a genuine comment (optional — earns +4 bonus coins)\n\n• Removing your like after claiming will result in coins being reclaimed', confirmText: 'I Understand — Open YouTube' },
...
export const TASK_DESCRIPTIONS = {
  ...
  like_comment: { emoji: '👍💬', label: 'Like + Comment', description: 'Like the video (required) + comment for bonus coins', verifiedBy: 'Like verified by API · Comment earns +4 bonus' },
